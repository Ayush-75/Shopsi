package com.ayushsapplication.app.modules.notificationoffer.`data`.model
...
data class NotificationOfferModel(
   ...
   * TODO Replace with dynamic value
   */
  var txtOffer: String? = MyApp.getInstance().resources.getString(R.string.lbl_the_best_title)
  ,
  /**
   * TODO Replace with dynamic value
   */
   ...
   * TODO Replace with dynamic value
   */
  var txtOffer1: String? = MyApp.getInstance().resources.getString(R.string.msg_summer_offer_98)
  ,
  /**
   * TODO Replace with dynamic value
   */
   ...
   * TODO Replace with dynamic value
   */
  var txtOffer2: String? = MyApp.getInstance().resources.getString(R.string.msg_special_offer_25)
  ,
  /**
   * TODO Replace with dynamic value
   */
